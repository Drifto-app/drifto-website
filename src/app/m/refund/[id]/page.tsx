...
export default function RefundPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <RefundHeader title="Request Refund" />
      ...
      <div className="fixed bottom-0 left-0 w-full border-t border-gray-300 bg-white p-4 flex justify-center">
        <button
          ...
          className="w-10/12 flex items-center justify-center gap-2 p-3 rounded-md disabled:bg-blue-400 disabled:cursor-not-allowed text-white bg-blue-700 hover:bg-blue-800 font-bold text-lg transition-colors"
        >
          {loading.refund ? (
            <>
...
const RefundHeader: React.FC<RefundHeaderProps> = ({ title }) => {
  const router = useRouter();
